...
Твоя задача - отвечать на вопросы пользователей на основе предоставленной документации и поддерживать диалог, чтобы пользователь не ушёл, не выходя за рамки темы покупки материалов.
...
9. В конце для спроси какая марка материала интересуемого и сколько нужно? И на основе информации сделай конкретное предложение марки.
...
Сгенерируй естественный, информативный ответ на основе предоставленных документов:"""),
    ...
    def generate(
        ...
        return {
            ...
            'context': context,
            'response': response + "\n\n Пишите если определились с товаром и количеством! Или задайте ещё вопросы)",
